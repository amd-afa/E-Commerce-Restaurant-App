...
A Flutter project as a simple example for E-Commerce Restaurant App called FRESHII where the user can discover new food-boxes and add them to cart then submit them to order (use firebase as BackEnd)
